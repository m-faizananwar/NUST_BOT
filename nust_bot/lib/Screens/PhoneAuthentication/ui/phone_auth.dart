...
import 'package:nust_bot/Screens/PhoneAuthentication/ui/otp_screen.dart';
import 'package:nust_bot/Screens/PhoneAuthentication/bloc/phone_authentication_bloc.dart';
                      ...
                      AppButton(
                        onTab: () async {
                          if (_formKey.currentState!.validate()) {
                            print('Phone Authentication Button Pressed');
                            phoneAuthenticationBloc.add(LoadingStateEvent());
                            try {
                              await FirebaseAuth.instance.verifyPhoneNumber(
                                ...
                                codeSent:
                                  ...
                                  print("phone auth file" + verificationId);
