...
import 'package:nust_bot/utils/chathistory.dart';
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                onTap: () async {
                                  List<ChatMessage> msgs = await getChatHistory(
                                      index, logoAsset, userLogo);
                                  setState(() {
      ...
      children: [
        ...
        DashChat(
          ...
          messageOptions: MessageOptions(
            ...
            containerColor:
                Colors.blue[900]!, // Slightly lighter purple for other users
